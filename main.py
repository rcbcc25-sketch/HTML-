...
MONGO_URI = "mongodb+srv://nenasingh00899:f9xxTAC4U0ip4gDp@cluster0.twjswal.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
def handle_txt_file(message: Message):
    ...
    try:
        ...
        html_path = f"𓍯𝕮𝖍o𝖚𝖍𝖆𝖓⚝{file_base}.html"
        ...
        with open(html_path, 'rb') as html_file, open(txt_path, 'rb') as txt_file:
            ...
            txt_file.seek(0)
            safe_send(bot.send_document, -1003363477758, txt_file,
                parse_mode="Markdown")

            # ✅ Channel me HTML bhejna (info ke sath)
            html_file.seek(0)
            safe_send(bot.send_document, -1003363477758, html_file,
